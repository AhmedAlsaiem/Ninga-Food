...
class ForgetPasswordEmailVerificationAuthSection extends StatefulWidget {
  const ForgetPasswordEmailVerificationAuthSection({super.key});

  @override
  State<ForgetPasswordEmailVerificationAuthSection> createState() =>
      _ForgetPasswordEmailVerificationAuthSectionState();
}

class _ForgetPasswordEmailVerificationAuthSectionState
    extends State<ForgetPasswordEmailVerificationAuthSection>
